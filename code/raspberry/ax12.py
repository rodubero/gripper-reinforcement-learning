...
class Ax12:
    ...
    def setPgain(self, id, newP):
        self.direction(Ax12.RPI_DIRECTION_TX)
        Ax12.port.flushInput()
        checksum = (~(id + Ax12.AX_GAIN_LENGTH + Ax12.AX_WRITE_DATA + Ax12.AX_P_GAIN + newP))&0xff
        outData = chr(Ax12.AX_START)
        outData += chr(Ax12.AX_START)
        outData += chr(id)
        outData += chr(Ax12.AX_GAIN_LENGTH)
        outData += chr(Ax12.AX_WRITE_DATA)
        outData += chr(Ax12.AX_P_GAIN)
        outData += chr(newP)
        outData += chr(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def setIgain(self, id, newI):
        self.direction(Ax12.RPI_DIRECTION_TX)
        Ax12.port.flushInput()
        checksum = (~(id + Ax12.AX_GAIN_LENGTH + Ax12.AX_WRITE_DATA + Ax12.AX_I_GAIN + newI))&0xff
        outData = chr(Ax12.AX_START)
        outData += chr(Ax12.AX_START)
        outData += chr(id)
        outData += chr(Ax12.AX_GAIN_LENGTH)
        outData += chr(Ax12.AX_WRITE_DATA)
        outData += chr(Ax12.AX_I_GAIN)
        outData += chr(newI)
        outData += chr(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
    ...
    def setDgain(self, id, newD):
        self.direction(Ax12.RPI_DIRECTION_TX)
        Ax12.port.flushInput()
        checksum = (~(id + Ax12.AX_GAIN_LENGTH + Ax12.AX_WRITE_DATA + Ax12.AX_D_GAIN + newD))&0xff
        outData = chr(Ax12.AX_START)
        outData += chr(Ax12.AX_START)
        outData += chr(id)
        outData += chr(Ax12.AX_GAIN_LENGTH)
        outData += chr(Ax12.AX_WRITE_DATA)
        outData += chr(Ax12.AX_D_GAIN)
        outData += chr(newD)
        outData += chr(checksum)
        Ax12.port.write(outData)
        sleep(Ax12.TX_DELAY_TIME)
